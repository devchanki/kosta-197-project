...
<head>
  ...
  <link href="/Aptogether/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/Aptogether/dist/vendor/css/fullcalendar.min.css" />
 	<link rel="stylesheet" href="/Aptogether/dist/vendor/css/bootstrap.min.css"> 
    <link rel="stylesheet" href='/Aptogether/dist/vendor/css/select2.min.css' />
    <link rel="stylesheet" href='/Aptogether/dist/vendor/css/bootstrap-datetimepicker.min.css' />
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="eventModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
				 ...
				 <div class="row">
                            <div class="col-xs-12">
                                <input class='IdNewEvent' id="edit-Id" type="hidden"></label>
                            </div>
                        </div>
                        
                        	<div class="row">
                            <div class="col-xs-12">
                                <input class='SeqNewEvent' id="edit-Apt-Seq" type="hidden"></label>
                            </div>
                        </div>
                       ...
                       <!--  <div class="row">
                        ...
                        <div class="row">
                           ...
                           <div class="row">
                            <div class="col-xs-12">
                                <label class="col-xs-4" for="edit-dong">동</label>
                                <input class="inputModal" type="text" name="edit-dong" id="edit-dong"
                                    required="required" />
                            </div>
                        </div>
