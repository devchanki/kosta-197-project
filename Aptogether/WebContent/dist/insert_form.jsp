...
<form action="/Aptogether/Market/insertaction.do" method="post" enctype="multipart/form-data">
	<div class="card-body">
	작성자: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="writer"><br><br>
	판매물품 :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="product_name"><br><br>
	가격:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="price"><br><br>
	</div>
	
	
	<div class="card-body">
	
	사진:<p></p><input type="file" name="fname"><p id="hey">
	<button id="dd" onclick="addimg()">사진 더 추가하기</button><br>
	</div>
	<div class="card-body">
	내용 <br>
	<textarea rows="6" cols="70" name="contents"></textarea>
	<br>
	판매중:<input type="text" name="isSale">
