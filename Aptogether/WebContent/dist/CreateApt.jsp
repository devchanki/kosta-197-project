						...
						new daum.Postcode(
								{
									oncomplete : function(data) {
										...
										console.log(data.bcode, data.bname, data.bname1, data.bname2);
										bjdCode = data.bcode;
										console.log(bjdCode);
										$.ajax({
										    ...
										    success: function(bjd){
												...
												for (var prop in json.aptInfo){
													...
													$('.apt-list').append('<div class="apt-list-detail">' + 
															json.aptInfo[prop].kaptName + '(' +
															json.aptInfo[prop].kaptCode + ')' + 
														 '<input type="button" id="button1" onclick="apt_select_click(' + json.aptInfo[prop].kaptCode + ')" value="선택" />'
															+ '<div>' )
												}
