...
<div class="card mb-4">
<div class="card-body">
<form action="/Aptogether/Market/updateaction.do" method="post" enctype="multipart/form-data">
	<div class="card-body">
	<input type="hidden" name="writer" value="${product.getWriter()}">
	<input type="hidden" name="seq" value="${product.seq}">
	작성자: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ${product.writer}<br><br>
	판매물품 :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="product_name" value="${product.product_name}"><br><br>
	가격:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="price" value="${product.price}"><br><br>
	</div>
	<div class="card-body">
	사진:<p></p><input type="file" name="fname" value="${product.fname}">
	</div>
	<div class="card-body">
	내용 <br>
